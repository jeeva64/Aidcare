...
urlpatterns=[
    ...
    path('trust_dashboard/view_donatedItems',views.view_donatedItems,name="view_donated"),

    path('trust_dashboard/approve_request/<int:request_id>/<str:email>/<str:username>/',views.approve_request,name="approve_request"),
